...
import DocumentLibrary from '../../../SAPAssetManager/Rules/Documents/DocumentLibrary';
...
import { WorkOrderLibrary as libWo, WorkOrderControlsLibrary as libWoControls, PrivateMethodsLibrary as libPrivate } from '../../../SAPAssetManager/Rules/WorkOrders/WorkOrderLibrary';
...
import TodaysServiceOrderDate from '../../../SAPAssetManager/Rules/ServiceOrders/TodaysServiceOrderDate';
import ModifyListViewSearchCriteria from '../../../SAPAssetManager/Rules/LCNC/ModifyListViewSearchCriteria';
import SoldToPartyLstPkrIsEditable from '../../../SAPAssetManager/Rules/ServiceOrders/CreateUpdate/SoldToPartyLstPkrIsEditable';
...
export class WorkOrderLibrary {
        ...
        return sectionProxy.read('/SAPAssetManager/Services/AssetManager.service', 'MyWorkOrderOperations', [], libOperations.attachOperationsFilterByAssgnTypeOrWCM(sectionProxy, query)).then(operations => {
            ...
            if (operations.length > 0) {
                for (let i = 0; i < operations.length; i++) {
                    ...
                    let operationStartDate = new ODataDate(operationRecord[field]);
            ...
            return todayOperations.length > 0 ? `(${todayOperations.join(' or ')})` : '';
        });
    }
        ...
        return sectionProxy.read('/SAPAssetManager/Services/AssetManager.service', 'MyWorkOrderHeaders', [], query).then(orders => {
            ...
            if (orders.length > 0) {
                for (let i = 0; i < orders.length; i++) {
                    ...
                    let orderStartDate = new ODataDate(orderRecord[field]);
            ...
            return todayOrders.length > 0 ? `(${todayOrders.join(' or ')})` : '';
        });
    }
    ...
    */
    ...
    static getWorkOrdersListViewQueryOptions(context) {
        ...
        queryBuilder.expand('WODocuments,WODocuments/Document,OrderMobileStatus_Nav/OverallStatusCfg_Nav,Operations,Operations/SubOperations,Operations/Tools,WOPriority,MarkedJob,UserTimeEntry_Nav,WOPartners,WOPartners/Employee_Nav');
    ...
    static getHighPriorityWorkOrdersQueryOptions(context) {
        ...
        queryBuilder.expand('WODocuments,WODocuments/Document,OrderMobileStatus_Nav/OverallStatusCfg_Nav,Operations,Operations/SubOperations,Operations/Tools,WOPriority,MarkedJob,WOGeometries,WOGeometries/Geometry,HeaderLongText,UserTimeEntry_Nav,WOPartners,WOPartners/Employee_Nav');
    ...
    static getWorkOrderDetailsNavQueryOption(context) {
        ...
        if (userFeaturesLib.isFeatureEnabled(context, context.getGlobalDefinition('/SAPAssetManager/Globals/Features/Checklist.global').getValue())) {
            return '$select=*,WOPartners/PartnerFunction,FunctionalLocation/FuncLocDesc,OrderMobileStatus_Nav/*&$expand=WODocuments,OrderMobileStatus_Nav/OverallStatusCfg_Nav,Equipment,FunctionalLocation,Operations,Operations/OperationLongText,Operations/Tools,Operations/SubOperations,WOGeometries/Geometry,MarkedJob,Confirmations,UserTimeEntry_Nav,WOObjectList_Nav,WOPartners/Address_Nav/AddressGeocode_Nav/Geometry_Nav,Address/AddressGeocode_Nav/Geometry_Nav,Equipment/Address/AddressGeocode_Nav/Geometry_Nav,EAMChecklist_Nav';
        } else {
            return '$select=*,WOPartners/PartnerFunction,FunctionalLocation/FuncLocDesc,OrderMobileStatus_Nav/*&$expand=WODocuments,OrderMobileStatus_Nav/OverallStatusCfg_Nav,Equipment,FunctionalLocation,Operations,Operations/OperationLongText,Operations/Tools,Operations/SubOperations,WOGeometries/Geometry,MarkedJob,Confirmations,UserTimeEntry_Nav,WOObjectList_Nav,WOPartners/Address_Nav/AddressGeocode_Nav/Geometry_Nav,Address/AddressGeocode_Nav/Geometry_Nav,Equipment/Address/AddressGeocode_Nav/Geometry_Nav';
        }
        //PTEN Modification
...
export class WorkOrderEventLibrary {
    ...
    static WorkOrdersListViewFormat(context) {
        ...
        switch (section) {
            ...
            case 'ConfirmationsSection':
            case 'WCMOverviewWorkorders':
            case 'ServiceQuotationItemDetailsSection':
