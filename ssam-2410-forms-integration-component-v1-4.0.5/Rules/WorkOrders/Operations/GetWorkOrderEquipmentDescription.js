...
/**
 * Retrieves the description of the equipment associated with the parent work
 ...
 * @returns {Promise<string|undefined>} The equipment description if found,
 *   undefined otherwise
 */
export default function GetWorkOrderEquipmentDescription(context) {
  let equipmentID = context.binding.WOHeader.HeaderEquipment;
