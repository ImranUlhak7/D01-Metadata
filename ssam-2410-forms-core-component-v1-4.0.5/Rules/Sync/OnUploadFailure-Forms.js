...
export default async function OnUploadFailure(context) {
    try {
        setSyncInProgressState(context, false);
        return context.executeAction('/MirataFormsCoreComponents/Actions/OData/ODataUploadFailureMessage-Forms.action');
    } catch (error) {
